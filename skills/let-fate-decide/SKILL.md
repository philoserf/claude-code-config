...
- [interpretation-guide.md](references/interpretation-guide.md) - How to read a 4-card spread and map it to technical decisions
...
4. Interpret the spread using the guide at [references/interpretation-guide.md](references/interpretation-guide.md)
...
After drawing, read each card's file and synthesize meaning. See [references/interpretation-guide.md](references/interpretation-guide.md) for the full interpretation workflow.
