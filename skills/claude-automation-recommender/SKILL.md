...
See [plugins-reference.md](plugins-reference.md) for available plugins.
...
See [output-template.md](output-template.md) for the full report template. Only include 1-2 recommendations per category — the most valuable ones for this specific codebase. Skip irrelevant categories.
