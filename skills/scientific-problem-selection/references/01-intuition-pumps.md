...
- [The Skill Workflow](#the-skill-workflow)
  - [Phase 1: Initial Discovery Questions](#phase-1-initial-discovery-questions-5-10-minutes)
  - [Phase 2: Applying Intuition Pumps](#phase-2-applying-intuition-pumps)
  - [Phase 3: Avoiding Common Traps](#phase-3-avoiding-common-traps)
  - [Phase 4: Literature Integration](#phase-4-literature-integration)
  - [Phase 5: Idea Refinement and Output](#phase-5-idea-refinement-and-output)
...
_This skill is based on the problem choice framework developed by Michael A. Fischbach and Christopher T. Walsh, as described in "Problem choice and decision trees in science and engineering" (Cell, 2024)._
