...
- [The Skill Workflow](#the-skill-workflow)
  - [Phase 1: Extract Project Assumptions](#phase-1-extract-project-assumptions-10-15-minutes)
  - [Phase 2: Comprehensive Assumption Listing](#phase-2-comprehensive-assumption-listing)
  - [Phase 3: Risk Scoring](#phase-3-risk-scoring-the-assumption-analysis-table)
  - [Phase 4: Risk Profile Evaluation](#phase-4-risk-profile-evaluation)
  - [Phase 5: Risk Mitigation Strategies](#phase-5-risk-mitigation-strategies)
  - [Phase 6: Go/No-Go Experiment Design](#phase-6-gono-go-experiment-design)
  - [Phase 7: Literature Validation](#phase-7-literature-validation)
  - [Phase 8: Revised Project Plan](#phase-8-revised-project-plan)
...
_Remember: Spending time on risk analysis is the most valuable investment a scientist can make. A well-understood risk profile enables moving forward with confidence or pivoting with clarity—both are valuable outcomes._
