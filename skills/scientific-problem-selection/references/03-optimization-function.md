...
- [The Skill Workflow](#the-skill-workflow)
  - [Phase 1: Project Categorization](#phase-1-project-categorization-5-minutes)
  - [Phase 2: Understanding the Three Main Frameworks](#phase-2-understanding-the-three-main-frameworks)
  - [Phase 3: Selecting and Articulating Your Framework](#phase-3-selecting-and-articulating-your-framework)
  - [Phase 4: Alternative or Custom Metrics](#phase-4-alternative-or-custom-metrics)
  - [Phase 5: Comparative Assessment](#phase-5-comparative-assessment)
  - [Phase 6: Avoiding Metric Mismatch](#phase-6-avoiding-metric-mismatch)
  - [Phase 7: Value System Discussion](#phase-7-value-system-discussion)
  - [Phase 8: Literature Benchmarking](#phase-8-literature-benchmarking)
  - [Phase 9: Communication Strategy](#phase-9-communication-strategy)
...
_Remember: Impact assessment isn't about ego—it's about ensuring work matters in the way the scientist wants it to matter. Explicit framing prevents years of misalignment._
