...
- [Strategy 1: Unfix Parameters](#strategy-1-unfix-parameters-in-crisis-mode)
- [Strategy 2: Comparable Goal Substitution](#strategy-2-comparable-goal-substitution)
- [Strategy 3: Answer Seeking Question](#strategy-3-answer-seeking-question)
- [Workflow](#workflow)
- [Output: Problem Inversion Analysis](#output-problem-inversion-analysis)
