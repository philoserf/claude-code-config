...
- [Pattern]: [Example: e.g., "**tests** for test directories"]
...
- Key files: install.js - handles bunx installation
- Subdirectories: None
...
- `bin/install.js` - Installation script (bunx entry)
...
_Structure analysis: 2025-01-20_
_Update when directory structure changes_
````
