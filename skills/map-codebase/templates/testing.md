...
```bash
[e.g., "bun test" or "bun run test"]              # Run all tests
[e.g., "bun test -- --watch"]                     # Watch mode
[e.g., "bun test -- path/to/file.test.ts"]       # Single file
[e.g., "bun run test:coverage"]                   # Coverage report
```
