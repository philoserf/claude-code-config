...
- **When OK**: Skill genuinely needs flexibility (e.g., meta-config-audit)
...
This command delegates to the **config-audit** agent.
```
...
```markdown
This command invokes the config-audit agent to perform validation.
```
