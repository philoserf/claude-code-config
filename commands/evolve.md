...
command: /evolve
implementation: ~/.claude/scripts/instinct-cli.py evolve
---
...
```bash
~/.claude/scripts/instinct-cli.py evolve [--generate]
```
...
1. Read all instincts from `~/.claude/learning/instincts/`
...
3. For each cluster of 3+ related instincts:
   ...
   - Save to `~/.claude/learning/evolved/{commands,skills,agents}/`
...
Files:
  - ~/.claude/learning/evolved/commands/new-table.md
...
Files:
  - ~/.claude/learning/evolved/skills/functional-patterns.md
...
Files:
  - ~/.claude/learning/evolved/agents/debugger.md
