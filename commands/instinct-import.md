...
implementation: ~/.claude/scripts/instinct-cli.py import <file>
---
...
```bash
~/.claude/scripts/instinct-cli.py import <file-or-url> [--dry-run] [--force] [--min-confidence 0.7]
```
...
5. Save to `~/.claude/learning/instincts/inherited/`
...
New instincts saved to: ~/.claude/learning/instincts/inherited/
