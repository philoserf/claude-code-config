...
implementation: ~/.claude/scripts/instinct-cli.py status
---
...
```bash
~/.claude/scripts/instinct-cli.py status
```
...
1. Read all instinct files from `~/.claude/learning/instincts/personal/`
2. Read inherited instincts from `~/.claude/learning/instincts/inherited/`
