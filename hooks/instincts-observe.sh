...
#     "PreToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": "~/.claude/hooks/instincts-observe.sh pre" }]
#     }],
#     "PostToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": "~/.claude/hooks/instincts-observe.sh post" }]
#     }]
#   }
# }
...
# Pass data via stdin and environment to avoid shell injection
OBSERVATIONS_FILE="$OBSERVATIONS_FILE" TIMESTAMP="$timestamp" python3 -c '
import json
import os
import sys
...
with open(os.environ["OBSERVATIONS_FILE"], "a") as f:
